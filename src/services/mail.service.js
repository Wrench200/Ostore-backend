...
class MailService {
    ...
    static getInstance(settings) {
      ...
      if (!MailService.instance) MailService.instance = new MailService(settings);
    ...
    async mail (receivers, subject, content, html =  false) {
console.log(this.settings.senderName);
        try {
...
module.exports = MailService.getInstance(configs.getMailSettings());
